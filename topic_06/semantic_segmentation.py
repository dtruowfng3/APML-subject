...
def download_video_segment(url, output_path="input_video_10s.mp4", start_time=0, duration=10):
    ydl_opts = {
    ...
    print(f"Downloaded video segment: {start_time}s-{start_time + duration}s -> {output_path}")
    return output_path

def segment_video(input_path, output_path="segformer_output.mp4"):
...
# video_path = download_video_segment(youtube_url, start="00:00:00", end="00:00:05")
video_path = download_video_segment(youtube_url, start_time=0, duration=10)
